...
from core.latex_citations import (
    extract_latex_citation_occurrences as _extract_latex_citation_occurrences,
)
from core.latex_parser import (
    is_latex_escaped,
    mask_latex_comments as _latex_scan_text,
    read_latex_group,
)
from i18n.i18n import tr

_latex_escaped = is_latex_escaped
_latex_balanced_group = read_latex_group
...
def extract_latex_citation_occurrences(text: str) -> list[dict]:
    """Compatibility export for the shared citation parser."""
    return _extract_latex_citation_occurrences(text)
